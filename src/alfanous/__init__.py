...
from alfanous.data import paths as PATHS  # noqa: F401
from alfanous.outputs import Fields as _fields
from alfanous.outputs import Raw as _search_engine

DEFAULTS, DOMAINS, HELPMESSAGES = (
    _search_engine.DEFAULTS,
    _search_engine.DOMAINS,
    _search_engine.HELPMESSAGES,
)
