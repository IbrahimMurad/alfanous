...
current_lib_usage = (
    information["lib_usage"]
    if "lib_usage" in information
...
setup(
    ...
    packages=[
        ...
        "alfanous.Support",
        "alfanous.Support.whoosh",
        "alfanous.Support.whoosh.filedb",
        "alfanous.Support.whoosh.lang",
        "alfanous.Support.whoosh.qparser",
        "alfanous.Support.whoosh.support",
        "alfanous.Support.PyArabic",
    ],
