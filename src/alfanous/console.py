...
INFORMATION = RAWoutput.do({"action": "show", "query": "information"})["show"][
    "information"
]
DOMAINS = RAWoutput.do({"action": "show", "query": "domains"})["show"]["domains"]
HELPMESSAGES = RAWoutput.do({"action": "show", "query": "help_messages"})["show"][
    "help_messages"
]
...
arg_parser.add_argument(
    ...
    dest="unit",
    type=str,
    choices=DOMAINS["unit"],
    help=HELPMESSAGES["unit"],
)
arg_parser.add_argument(
    "-q", "--query", dest="query", type=str, help=HELPMESSAGES["query"]
)
arg_parser.add_argument(
    "-o",
    "--offset",
...
arg_parser.add_argument(
    ...
    dest="view",
    type=str,
    choices=DOMAINS["view"],
    help=HELPMESSAGES["view"],
)
arg_parser.add_argument(
    "--page", dest="page", type=int, metavar="NUMBER", help=HELPMESSAGES["page"]
)
arg_parser.add_argument(
    "--perpage",
    dest="perpage",
...
arg_parser.add_argument(
    ...
    metavar="NUMBER",
    type=str,
    help=HELPMESSAGES["recitation"],
)
arg_parser.add_argument(
    "--translation", dest="translation", type=str, help=HELPMESSAGES["translation"]
)
arg_parser.add_argument(
    "--romanization", dest="romanization", type=str, help=HELPMESSAGES["romanization"]
)
arg_parser.add_argument(
    "--highlight",
    dest="highlight",
    type=str,
    choices=DOMAINS["highlight"],
...
arg_parser.add_argument(
    ...
    dest="script",
    type=str,
    choices=DOMAINS["script"],
    help=HELPMESSAGES["script"],
)
arg_parser.add_argument(
    "--vocalized",
    dest="vocalized",
...
arg_parser.add_argument(
    ...
    dest="platform",
    type=str,
    choices=DOMAINS["platform"],
    help=HELPMESSAGES["platform"],
)
arg_parser.add_argument(
    "--domain", dest="domain", type=str, help=HELPMESSAGES["domain"]
)
