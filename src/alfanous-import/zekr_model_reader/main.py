...
class Ta7rif(Exception):
    ...
    def __init__(
        self, type="new", value="undefined", original=None, aya_gid=None, msg=""
    ):
        self.type = type
...
class TranslationModel:
    ...
    def document_list(self):
        ...
        for i in range(6236):
            doc = {
                "gid": i + 1,
                "id": props["id"].decode(props["encoding"]),
                "text": lines[i].decode(props["encoding"]),
                "type": "translation",
                "lang": props["language"].decode(props["encoding"]),
                "country": props["country"].decode(props["encoding"]),
                "author": props["name"].decode(props["encoding"]),
                "copyright": props["copyright"].decode(props["encoding"]),
                "binary": None,
            }  # the same of the schema
            yield doc
